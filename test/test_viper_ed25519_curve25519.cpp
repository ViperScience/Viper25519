...
auto test_ExtendedPoint_add() -> void
{
    ...
    const auto q = curve25519::ExtendedPoint{std::array<bignum25519, 4>{
        bignum25519{
            0x0000cace8906d510, 0x00014882e10cb563, 0x000526b6cfff4fa8,
            0x0006366e1a07b39d, 0x0002439920a9a719
        },
        bignum25519{
            0x000702c4dff032c5, 0x0007a7c8ca27d9cf, 0x00074244ca478fce,
            0x0007804a15806b61, 0x00020a76af14da34
        },
        bignum25519{
            0x00057313a73e7cd5, 0x00034762b17c3942, 0x0006fcdae5c42154,
            0x0007715567434525, 0x00004ca2c705172a
        },
        bignum25519{
            0x00053ac5aaf4e78d, 0x0004b758b5ab6e53, 0x0006f498d6744908,
            0x00023f7280a458cf, 0x0005594c8e9ff60d
        }
    }};

    auto r_comp = p.add(q);

    constexpr auto x_donna0 = curve25519::bignum25519{
        0x000e2f55bbec07ad, 0x000aaf698f07d3f1, 0x000abe08a6216bab,
        0x00145a1f0176c8f9, 0x0013aa0526027c1e
    };
    constexpr auto y_donna0 = curve25519::bignum25519{
        0x000339b3bb211715, 0x0009683d221dfcdd, 0x000834da06d41023,
        0x0009cd9473f0a757, 0x0009e8734f93617e
    };
    constexpr auto z_donna0 = curve25519::bignum25519{
        0x001123d1347ebbb9, 0x000b798fbdda2d5a, 0x000fd8cc74219af7,
        0x00148366d85add0f, 0x00031d8cc3c38283
    };
    constexpr auto t_donna0 = curve25519::bignum25519{
        0x0024a87d687b374f, 0x0021a3fb0816b7aa, 0x002c1a9f22eeea55,
        0x002941eec4b23781, 0x001e14fe5850da21
    };

    TEST_ASSERT_THROW(r_comp.x() == x_donna0)
    TEST_ASSERT_THROW(r_comp.y() == y_donna0)
    TEST_ASSERT_THROW(r_comp.z() == z_donna0)
    TEST_ASSERT_THROW(r_comp.t() == t_donna0)

    auto r_ext = p + q;

    constexpr auto x_donna1 = curve25519::bignum25519{
        0x000235f5e929e0c0, 0x0007f2b2c7453a6f, 0x000063ca53c6bab7,
        0x0006ddc00f5452bd, 0x0001f1dceaff67d5
    };
    constexpr auto y_donna1 = curve25519::bignum25519{
        0x00037e62ef76ba49, 0x0005b5fa898cd7c2, 0x0006a671f5a6d756,
        0x0002f92f370ef809, 0x000590de0bffba52
    };
    constexpr auto z_donna1 = curve25519::bignum25519{
        0x000068fe1db90367, 0x000047b2a1f7a5cf, 0x000259520034fc8e,
        0x000162a9a3cf1ce9, 0x0004308feb249db8
    };
    constexpr auto t_donna1 = curve25519::bignum25519{
        0x0007f80e3cf86955, 0x000474cb1daf09d4, 0x0000ffe6deaad214,
        0x0000469c5226f948, 0x00017637e064dca5
    };

    TEST_ASSERT_THROW(r_ext.x() == x_donna1)
    TEST_ASSERT_THROW(r_ext.y() == y_donna1)
    TEST_ASSERT_THROW(r_ext.z() == z_donna1)
    TEST_ASSERT_THROW(r_ext.t() == t_donna1)
}

auto test_ExtendedPoint_addPrecomp_v1() -> void
{
    constexpr auto xaddy_donna = curve25519::bignum25519{
        0x00065f364da3dc0f, 0x0006e3c12eacd23c, 0x0007f1a3ee691b7d,
        0x0009d6dae0be207b, 0x0006f1383f3efa04
    };
    constexpr auto ysubx_donna = curve25519::bignum25519{
        0x000d98dfd95ba55d, 0x000cd97d17a46c90, 0x0010886e37e920ff,
        0x001365276fede2dd, 0x000adf1b7639acca
    };
    constexpr auto z_donna = curve25519::bignum25519{
        0x000055cc4e9cf9e3, 0x00028d1d8ac5f0e5, 0x0004bbf36b971085,
        0x00055dc5559d0d14, 0x0006e1328b1c145c
    };
    constexpr auto t2d_donna = curve25519::bignum25519{
        0x0004a7564745c7a5, 0x0007c299703a529a, 0x0000b815848b1652,
        0x0006745899671f09, 0x0000edcc8e006dd0
    };
    ...
    const auto q =
        curve25519::ExtendedPrecomputedPoint{std::array<bignum25519, 4>{
            bignum25519{
                0x00032ac48a2214f6, 0x0002f01cb9f620bc, 0x000a87abb5d3ce41,
                0x0007430145e326c8, 0x0004480275d3c7cc
            },
            bignum25519{
                0x0012383f790ea092, 0x000f84e2d8ff4d04, 0x00110f5cbbfc6ce3,
                0x000b6c23ddc3b428, 0x000f021e89193b72
            },
            bignum25519{
                0x0000000000000001, 0x0000000000000000, 0x0000000000000000,
                0x0000000000000000, 0x0000000000000000
            ...
            bignum25519{
                0x000658330b54124e, 0x000123331fdcf281, 0x0003e2557c028372,
                0x00066f3e5156223f, 0x00033f1759186581
            }
        }};
...
auto test_ExtendedPoint_addPrecomp_v2() -> void
{
    ...
    constexpr auto x_donna0 = curve25519::bignum25519{
        0x00153517823fa6a4, 0x000fd219c0dddf8d, 0x0010bb661fb09ab6,
        0x000b3ae7703f0408, 0x000eb69d9e9e9613
    };
    constexpr auto y_donna0 = curve25519::bignum25519{
        0x0009a2e6b4ccdf76, 0x000bb0da2c66ded5, 0x000b0994fe404272,
        0x000a9030362616ac, 0x00061ed2c9c34d09
    };
    constexpr auto z_donna0 = curve25519::bignum25519{
        0x000132e58b08f3cd, 0x000772d56da744f0, 0x0001ac3bc835e980,
        0x00063705375c9643, 0x0001a48242cea9ba
    };
    constexpr auto t_donna0 = curve25519::bignum25519{
        0x000ecd1a74f70c11, 0x00088d2a9258bb0e, 0x000e53c437ca167e,
        0x0009c8fac8a369bb, 0x000e5b7dbd315644
    };
    ...
    constexpr auto x_donna1 = curve25519::bignum25519{
        0x000fffffffffffda, 0x000ffffffffffffe, 0x000ffffffffffffe,
        0x000ffffffffffffe, 0x000ffffffffffffe
    };
    constexpr auto y_donna1 = curve25519::bignum25519{
        0x000132e58b08f3ba, 0x000772d56da744f0, 0x0009ac3bc835e980,
        0x00063705375c9642, 0x0009a48242cea9ba
    };
    constexpr auto z_donna1 = curve25519::bignum25519{
        0x000ecd1a74f70c11, 0x00088d2a9258bb0e, 0x000e53c437ca167e,
        0x0009c8fac8a369bb, 0x000e5b7dbd315644
...
auto test_ExtendedPoint_multiplyBasepointByScalar() -> void
{
    ...
    constexpr auto x2_donna = curve25519::bignum25519{
        0x00062b0f24758d96, 0x00056e645fa9b99f, 0x00065ca9e986a331,
        0x0006445717934f96, 0x00037bb64b57bfd2
    };
    constexpr auto y2_donna = curve25519::bignum25519{
        0x0006772d7403b6f4, 0x0002218c2a0d3b90, 0x000667845a512eab,
        0x0003aff484fe5c0f, 0x000709cded587b35
    };
    constexpr auto z2_donna = curve25519::bignum25519{
        0x0004b3ae0f1c61a5, 0x0003b699a6e095cf, 0x0000330f68d32796,
        0x000033c15acb23e5, 0x000366e5d53ab739
    };
    constexpr auto t2_donna = curve25519::bignum25519{
        0x0000e1cc01561ef1, 0x00079dc021400c9e, 0x00004b5a2fe0468d,
        0x00073714d4c82967, 0x0000e093f956af9f
    };
...
auto test_ExtendedPoint_unpack() -> void
{
    ...
    constexpr auto bytes =
        std::array<uint8_t, 32>{0xd7, 0x5a, 0x98, 0x01, 0x82, 0xb1, 0x0a, 0xb7,
...
{
    constexpr auto x_donna = curve25519::bignum25519{
        0x00054b919ad90ff8, 0x0006d4293f7b422c, 0x00057566212466bb,
        0x00070d430077bf93, 0x0001ced251a2fef4
    };
    constexpr auto y_donna = curve25519::bignum25519{
        0x0004eaa0223caeee, 0x00022366f2efbe7e, 0x00064e49018e6ce3,
        0x00072353fe7a0c02, 0x0002f43ba9331d20
    };
    constexpr auto z_donna = curve25519::bignum25519{
        0x0002710d204750ac, 0x0004bcfafe29176a, 0x0002ee2c637a123d,
        0x0007f9892131fd37, 0x0000590929c555fd
    };
    constexpr auto t_donna = curve25519::bignum25519{
        0x0007329797d37fd2, 0x0005b0865d9df5d9, 0x0001920661844503,
        0x00042decac580cd8, 0x0007d8caaaf04880
    };

    constexpr auto s1 = curve25519::bignum25519{
        0x00ecab516fee6a0f, 0x00115b227cd7b44f, 0x007b69c5494446f3,
        0x0003ac3b70196932, 0x00000000007fae1c
    };
    constexpr auto s2 = curve25519::bignum25519{
        0x00003905d740913e, 0x0000ba2817d673a2, 0x00023e2827f4e67c,
        0x000133d2e0c21a34, 0x00044fd2f9298f81
    };
...
auto test_CompletedPoint_toExtended() -> void
{
    const auto p1 = curve25519::CompletedPoint{std::array<bignum25519, 4>{
        bignum25519{
            0x0021a8bc11fd35f1, 0x001e90ce06eefc79, 0x001ddb30fd84d5bc,
            0x0021d73b81f8204d, 0x001db4ecf4f4b09f
        },
        bignum25519{
            0x00051735a666fc0f, 0x000586d16336f6b1, 0x00084ca7f202139b,
            0x00048181b130b56a, 0x0008f6964e1a6852
        },
        bignum25519{
            0x0011972c58479e55, 0x001396ab6d3a277f, 0x000d61de41af4c05,
            0x0011b829bae4b218, 0x0015241216754dd4
        },
        bignum25519{
            0x001668d3a7b8616c, 0x0014695492c5d87c, 0x001a9e21be50b3f6,
            0x001647d6451b4de3, 0x0012dbede98ab227
        }
    }};
